...
Page({
  ...
  handleFilterChange(e) {
    console.log('rjl__2' + JSON.stringify(e));
    const {
      layout,
      overall,
      sorts
  ...
  async init(reset = true) {
    console.log('rjl___' + JSON.stringify(this.data));
    const {
      loadMoreStatus,
      goodsList = []
    } = this.data;
    const params = this.categoryId;
    ...
    try {
      ...
      if (code.toUpperCase() === 'SUCCESS') {
        ...
        const _goodsList = reset ? listData : goodsList.concat(listData);
